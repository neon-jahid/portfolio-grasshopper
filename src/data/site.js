...
export const personal = {
    ...
    lead: 'ব্যস্ততার বাইরে একটা জীবন আছে—আর সেই জীবনটা আমি আমার প্রিয় মানুষগুলোর সাথে কাটাতে পছন্দ করি। 😊',
    paragraphs: [
        'ফ্রি সময় বলতে এখন আমার যেটুকু আছে, সেটা মূলত সাপ্তাহিক ছুটি। আর সেই ছুটিটুকু নিজের মতো করে কাটাতেই বেশি ভালো লাগে। কখনো মুভি দেখা, কখনো কোথাও ঘুরতে বের হওয়া, কখনো একটু স্পেশাল কিছু রান্না করা—আবার কখনো বারান্দার গাছপালা নিয়ে ব্যস্ত হয়ে পড়া। Gardening করতে বেশ ভালো লাগে; গাছের যত্ন নেওয়ার মধ্যে একটা আলাদা শান্তি আছে। ভিড়ের চেয়ে নিরিবিলি পরিবেশ বেশি পছন্দ করি। খুব বেশি কোলাহল বা সবসময় মানুষের মাঝে থাকার প্রয়োজন অনুভব করি না। বরং এক কাপ চা, একটা ভালো বই আর নিজের সঙ্গে কিছুটা সময়—আমার কাছে এর চেয়ে সুন্দর সময় খুব বেশি নেই। বারান্দায় বসে বই পড়ছি, আর হঠাৎ কেউ একজন এক কাপ রঙ চা হাতে এসে বলবে, “চা।” — এমন একটা ছোট্ট মুহূর্তের অপেক্ষায় আছি। ভালো গান শুনতে, প্রকৃতির কাছাকাছি থাকতে, লম্বা হাঁটতে আর সুযোগ পেলেই একটু দূরে কোথাও ঘুরে আসতেও ভালো লাগে। জীবনের খুব বড় কিছু না, ছোট ছোট সুন্দর মুহূর্তগুলো উপভোগ করতে পারাটাই আমার কাছে বেশি গুরুত্বপূর্ণ। নিরব থাকতে পছন্দ করি, তবে মানুষকে বুঝতে এবং সম্মান করতে চেষ্টা করি। সবসময় চেষ্টা থাকে, আমার কারণে যেন অন্য কারও দিনটা খারাপ না হয়। ভালো ব্যবহার করার বিষয়টা আমার কাছে খুব সাধারণ একটা মানবিক ব্যাপার—তাই যতটা পারি সেটা মেনে চলি। আর একান্ত ব্যক্তিগত মানুষের গল্পে আপাতত না-ই আসি! 😁 কিছু গল্প ব্যক্তিগত থাকলেই বোধহয় বেশি সুন্দর।',
    ],
...
export const socials = [
    ...
    { label: 'Instagram', href: 'https://instagram.com/xahid.zx', icon: 'instagram' },
    { label: 'ইমেইল', href: 'mailto:#', icon: 'mail' },
];
